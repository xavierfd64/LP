...
/**
 * One modal, two modes — same create/edit-share pattern as
 * CategoryFormModal (Aug 20 2nd update). Uses the shared Modal (Sept 9 —
    ...
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} maxWidthClassName="max-w-lg">
        <ModalHeader
          ...
          subtitle={supplier ? "Update this supplier's contact and payment details." : "Add a new supplier for material purchases."}
