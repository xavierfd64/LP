...
/** Same interaction shape as CancelQuotationForm — a required reason, confirm/back. */
export function CancelOrderForm({ orderId }: { orderId: string }) {
  ...
  return (
    <form action={formAction} className="space-y-3 rounded-md border border-red-200 bg-red-50 p-4">
      ...
      <Textarea name="reason" rows={2} required placeholder="Reason — e.g. customer requested cancellation, duplicate order..." />
